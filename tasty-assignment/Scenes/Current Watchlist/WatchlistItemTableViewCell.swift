...
class WatchlistItemTableViewCell: UITableViewCell {
    ...
    private func bind(_ quotesPublisher: ResultPublisher<StockQuoteResponse, APIError>) {
        quotesPublisher
    ...
    func bind(_ symbol: String, with publisher: ResultPublisher<StockQuoteResponse, APIError>) {
